                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="myNavbar">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a>Contact</a></li>
                                        <li><a href="paintingform.php">Upload your painting</a></li>
                                        <li><a href="auction.php">Start an auction</a></li>
                                    </ul>
                                </div>
                            </div>
                        </nav>
            ...
            <div class="box latest-product-heading">
                ...
                <div class="box-content">
                    <div class="row">
                        ...
                        $aid=mysqli_real_escape_string($conn,$_SESSION['userid']);


                        $sql = "SELECT * FROM painting where artst_id=$aid";
                        ...
                        while($row = $result->fetch_assoc()  ) {
                            ...
                            <div class="product-thumb transiction">
                                ...
                                <div class="caption">
                                    ...
                                    <div class="price">
                                        <span class="price-new">₹'.$row["cost"].'</span><br>
                                          <span class="price-new">Painting Id:'.$row["paintingid"].'</span>
