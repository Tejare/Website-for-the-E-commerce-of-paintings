        ...
        <div class="main-content">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a>Return Painting</a></li>
                </ul>
                <form class="form-horizontal" action="check_return.php" method="post">
                    <fieldset id="account">
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                ...
                                $sql = "SELECT * FROM painting INNER JOIN customer where painting.custId=customer.custId";
